"""
Versao antiga do programa Procura de artigos em ficheiros xls Alemaes
Tentativa de procura de artigos nos ficheiros em xls
01/02/2023
...
def exp1(palavra_procurada):
    print(f'Lista -> {palavra_procurada}')
